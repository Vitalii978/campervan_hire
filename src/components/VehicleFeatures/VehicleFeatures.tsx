...
export default function VehicleFeatures({ features }: VehicleFeaturesProps) {
  ...
  const equipmentList = [
    ...
    { key: 'transmission', label: 'Automatic', value: features.transmission === 'automatic', icon: 'automatic' },
    { key: 'kitchen', label: 'Kitchen', value: features.kitchen, icon: 'kitchen' },
    { key: 'TV', label: 'TV', value: features.TV, icon: 'TV' },
    { key: 'bathroom', label: 'Bathroom', value: features.bathroom, icon: 'bathroom' },
    { key: 'engine', label: 'Petrol', value: features.engine === 'petrol', icon: 'fuel' },
    { key: 'radio', label: 'Radio', value: features.radio, icon: 'boom-box' }, // Изменено на boom-box
    { key: 'refrigerator', label: 'Refrigerator', value: features.refrigerator, icon: 'refrigerator' },
    { key: 'microwave', label: 'Microwave', value: features.microwave, icon: 'microwave' },
  ...
  const activeEquipment = equipmentList.filter(item => 
    item.value === true
  );
